...
const PersonalData = () => {
    ...
    const handleSave = async () => {
        try {
            await saveUserData(tempPersonalData);
            ...
            <div className="personal-data-grid">
                <div className="data-field">
                    ...
                    {isEditing ? (
                        ...
                        <span className="data-value">{personalData.firstName || 'Nu este specificat'}</span>
                    )}
                </div>
                ...
                <div className="data-field">
                    ...
                    {isEditing ? (
                        ...
                        <span className="data-value">{personalData.lastName || 'Nu este specificat'}</span>
                    )}
                </div>
                ...
                <div className="data-field">
                    ...
                    {isEditing ? (
                        ...
                        <span className="data-value">{personalData.email || 'Nu este specificat'}</span>
                    )}
                </div>
                ...
                <div className="data-field">
                    ...
                    {isEditing ? (
                        ...
                        <span className="data-value">{personalData.phone || 'Nu este specificat'}</span>
                    )}
                </div>
                ...
                <div className="data-field">
                    ...
                    {isEditing ? (
                        ...
                        <span className="data-value">{personalData.address || 'Nu este specificată'}</span>
                    )}
                </div>
                ...
                <div className="data-field">
                    ...
                    {isEditing ? (
                        ...
                        <span className="data-value">{personalData.county || 'Nu este specificat'}</span>
                    )}
                </div>
                ...
                <div className="data-field">
                    ...
                    {isEditing ? (
                        ...
                        <span className="data-value">{personalData.city || 'Nu este specificat'}</span>
                    )}
                </div>
